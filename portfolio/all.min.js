...
portfolio.factory('projectsService', ['$q', '$http', '$rootScope', function ($q, $http, $rootScope) {
...
'$rootScope', function ($scope, $http, $window, projectsService, $location, $anchorScroll, $document, $rootScope /*, uiGmapGoogleMapApi, ColorService, ScrollService*/) {
	var _this = this;
