...
var portfolio = angular.module('portfolio', ['ngAnimate', 'ngSanitize', 'mobile-angular-ui', 'mobile-angular-ui.gestures.drag', 'ngAnimate', 'ngSanitize']);
portfolio.factory('carouselService', [function () {
	var _itemCount = 0;
	...
	return {
		...
		addItem: function addItem() {
			var newId = _itemCount++;
			_activeItem = _itemCount === 1 ? newId : _activeItem;
			return newId;
		},
		next: function next() {
			_activeItem = _activeItem || 0;
			_activeItem = _activeItem === _itemCount - 1 ? 0 : _activeItem + 1;
		},
		prev: function prev() {
			_activeItem = _activeItem || 0;
			_activeItem = _activeItem === 0 ? _itemCount - 1 : _activeItem - 1;
		}
	};
}]);
...
portfolio.directive('carouselItem', ['$drag', 'carouselService', function ($drag, carouselService) {
	return {
		restrict: 'C',
		scope: {},
		transclude: true,
