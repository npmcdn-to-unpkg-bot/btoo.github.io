...
portfolio.directive('actionMenuButton', function () {
	return {
...
portfolio.directive('animejsExplosion', ['$q', 'landingService', function ($q, landingService) {
	return {
		restrict: 'AE',
			...
			landingService.canAnimateExplosion().then(function () {
				...
				var animate = anime({
					...
					update: function update(animation) {
						...
						if (animation.progress > 50) landingService.animatedExplosion();
					}
				});
